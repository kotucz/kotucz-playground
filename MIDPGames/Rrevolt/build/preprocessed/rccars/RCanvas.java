...
//            return helpG;
    ...
    public void paint(Graphics g) {	
        ...
        g.setColor(0xFFFFFF);
        g.drawString("speed "+car1.getSpeed(), 10, 10, Graphics.TOP|Graphics.LEFT);
    }


    private float[] camera = {0, 0, 0, 90, 0};	//0-X,1-Y,2-Z,3-RotZ,4-RotX

    /**
     * makes the camera follow the racers car
     */
...
//        camGG.setTranslation(camera[0], camera[1], camera[2]);
        ...
        cam.setPerspective(45f+car1.getSpeed(), (float) getWidth() / (float) getHeight(), 0.1f, 3000);
