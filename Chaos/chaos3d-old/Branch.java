...
public class Branch extends PlantPart {
	...
	public Branch(Branch part) {
	    ...
	    size = 0;
	    if (plant.genom.getGrowRatioUpdepth() < this.depth) maxSize = (int) ((double) part.maxSize * plant.genom.getGrowRatio(Genom.BRANCH));
	    else maxSize = plant.genom.getGrowLength(Genom.BRANCH);
