...
//        addChild(Tools.superBox(1, 1, 2, "sold-duck1.png"));
        ...
        addChild(sound);
        Node createTextNotification = createTextNotification(soldier.toString(), new Color3f(0, 1, 0));
        createTextNotification.setPickable(false);
        addChild(createTextNotification);
    }
