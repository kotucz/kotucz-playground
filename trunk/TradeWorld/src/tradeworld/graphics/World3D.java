...
public class World3D {
    ...
    // visualization
    public final MyCanvas3D canvas3D;
...
//            canvas3D = new Canvas3D(preferredConfiguration);
            if (world!=null) {
                canvas3D = new MyCanvas3D(world.getGame(), preferredConfiguration);
            } else {
                canvas3D = new MyCanvas3D(null, preferredConfiguration);
...
//            canvas3D.setPreferredSize(new Dimension(800, 800));
        ...
        //AudioDevice dev =
//        AudioDevice audioDev = universe.getViewer().createAudioDevice();
//        System.out.println("Audio device: "+universe.getViewer().getPhysicalEnvironment().getAudioDevice());
//        universe.getViewer().getPhysicalEnvironment().getAudioDevice()
//                setAudioDevice(null).
//        AudioDevice; audioDev = universe.getViewer().createAudioDevice();
    }
...
//        return vehiclesMap.get(closest.getNode(0));
    ...
    public WorldObject getAssociatedObject(Node node) {
        return objectsMap.get(node);
    }
...
//        this.vehicles.addChild(model.getRoot());
    ...
    public void removeModel(Model3D model) {
        model.setWorld(null);
        objectsMap.remove(model.getRoot());
