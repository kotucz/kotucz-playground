...
public class Model3D {
    ...
    public final void setTransform(Point3d pos) {
        setTransform(pos, 0);
    }
    ...
    final void setWorld(World3D world) {
        this.world = world;
    }

    /**
     * for users to owerride
     * TODO listeners and observer interfaces?
     * @param world
     */
    public void addedTo(World3D world) {
