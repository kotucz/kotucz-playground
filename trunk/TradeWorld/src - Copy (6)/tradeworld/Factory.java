...
public class Factory extends Building {
    ...
    private int progress; // 0..x = progress, -1 = not working,
    private WorkingState workingState;
    private EnableState enableState;

    public Factory(Type type, Player owner, Point3d upperLeft) {
            ...
            if (WorkingState.WORKING.equals(workingState)) {
                ...
                if (selectedProductionChain != null) {
                    if (progress >= selectedProductionChain.getSpeed()) {
                        getWorld().showNotification(new Notification3D(this.getPos()));
