...
//        addChild(new ColorCube());
        NotificationBehavior notificationBehavior = new NotificationBehavior(this);
...
//        appear.setTexture(Tools.loadTexture("road1.png"));
    ...
    class NotificationBehavior extends Behavior {
        ...
        private final Notification3D notification;

        public NotificationBehavior(Notification3D notification) {
...
//            System.out.println("stimulus");
            ...
            if (pos.z > 1.5) {
//                remove();
                getWorld().removeNotification(notification);
            }
