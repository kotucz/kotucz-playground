...
import cz.kotuc.android.towerdefence.GameView.GameThread;
...
public class GameActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gameView = (GameView) findViewById(R.id.lunar);		
		
		gameView.initButtons();
...
//		}
	...
	// // TODO Auto-generated method stub
	// Log.e("touch", "dispatch activity event");
	// return super.dispatchTouchEvent(ev);
	// }
	//
	// @Override
	// public boolean onTouchEvent(MotionEvent event) {
	// Log.e("touch", "activity event");
	// return mLunarView.board.onTouchEvent(event); // true if consumed event
	// // return super.onTouchEvent(event);
	// }
