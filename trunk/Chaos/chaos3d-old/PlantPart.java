...
//	    this.pos = (Point3d)part.endpos.clone();
	    endpos = new Point3d();
	   	//endpos();
	    size = 0;
	    if ((type == Genom.BRANCH) && (plant.genom.getGrowRatioUpdepth() < this.depth)) maxSize = (int) ((double) part.maxSize * plant.genom.getGrowRatio(type));
	    else maxSize = plant.genom.getGrowLength(type);
	...
	public abstract void nodeActivity (); /*{
