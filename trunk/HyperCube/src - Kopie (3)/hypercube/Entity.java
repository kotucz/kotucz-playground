...
//        this.y = y;
    ...
    public void paint(Graphics g, long time) {
        ...
        g.drawString(""+(time+timeShift), x, y);
...
//                System.out.println("   - "+copy+" (copy) in "+copy.timeShift);
    ...
    public String toString() {
        return "Ent "+super.toString().substring(15)+" at "+(timeShift);
    }
    
    
    /**
     * 
     * @return local time coresponds to its timeline
     */
    long getLocalTime() {
        return 0;
    }
    ...
    /**
     * 
     * @return time of the environment, where it 
     */
