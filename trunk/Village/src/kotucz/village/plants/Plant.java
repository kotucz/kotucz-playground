...
public class Plant {
    ...
    public Plant(Modeler modeler, PhysicsSpace physicsSpace, Vector3f origin, boolean ghost) {

        torso = createBody(modeler.matPipes, origin.add(0, 0, 2));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            Leg leg = createLeg(modeler, physicsSpace, origin, vector3fs[i], i);
