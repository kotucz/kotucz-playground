...
/*
        ...
        */
        ...
        String ress = "døevo: "+lumber+" hlina: "+clay+" železo: "+iron+" obilí: "+crop;
        println(ress);
...
/// unit movement        
        ...
        movesLabel.setText(">>útok: "+decodeRemainingTime(inattacks)/60000+"min \n>>podp.: "+decodeRemainingTime(insupport)/60000+"min");
...
//            try {
//                return new String(new String(""+id+" "+label+" úroveò "+level).getBytes("UTF-8"), "UTF-8"); 
//            } catch (UnsupportedEncodingException ex) {
//                ex.printStackTrace();
//                return new String(""+id+" "+label+" úroveò "+level);
//            } 
        }
