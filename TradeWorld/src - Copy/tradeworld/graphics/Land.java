...
//        }
        ...
        tus[1] = loadTextureUnit("road1.png", TextureAttributes.DECAL);

        // modulated light map
//        tus[1] = loadTextureUnit("mega4.png", TextureAttributes.MODULATE);
        // tus[2] = lightMapTUS();
...
//		return new Appearance();
    ...
    private TextureUnitState loadTextureUnit(String fnm, int texAttr) /* Create a texture unit state by combining a loaded texture
    and texture attributes. Mipmaps are generated for the texture.
     */ {
        TextureLoader loader =
                new TextureLoader("res/images/" + fnm, TextureLoader.GENERATE_MIPMAP, null);
