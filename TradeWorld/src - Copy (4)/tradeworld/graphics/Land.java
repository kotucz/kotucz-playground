 ...
 * @author Kotuc
 */
public class Land extends Model3D {
...
//        }
        ...
        RoadNetwork net = new RoadNetwork(widthx + 1, widthy + 1);

        TextureSelect[] selects = new TextureSelect[]{
...
//                        (roads[x + 1][y + 1] * 2) +
//                (roads[x][y + 1] * 1);
                int hash = ((net.getPoint(x, y) != null) ? 8 : 0) +
                        ((net.getPoint(x + 1, y) != null) ? 4 : 0) +
                        ((net.getPoint(x + 1, y + 1) != null) ? 2 : 0) +
                        ((net.getPoint(x, y + 1) != null) ? 1 : 0);
