...
//    }
    ...
    public static Texture2D loadTexture(String fileName, boolean tiled) {
...
//            tex.setBoundaryModeT(Texture2D.CLAMP_TO_BOUNDARY);
    ...
    public static TextureUnitState loadTextureUnit(String fileName, int texAttr) {
        Texture2D tex = loadTexture(fileName, true);
    ...
    public static Node superBox(Vector3d halfSize, String textureFile) {
        return superBox(2*halfSize.x, 2*halfSize.y, 2*halfSize.z, textureFile);
    }
