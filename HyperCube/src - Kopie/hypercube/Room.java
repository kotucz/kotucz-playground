...
public class Room {
    ...
    public void restart() {
        time = 0;
        player = new Entity(this, time, 100, 100, 20, 40, Color.GREEN);
        entities.add(player);
        Entity box = new Entity(this, time, 150, 150, 20, 20, Color.YELLOW);
        entities.add(box);
        Entity floor = new Entity(this, time, 50, 200, 200, 20, Color.RED);
        floor.solid = true;
        entities.add(floor);
    }
